...
namespace MaddeningJinx
{
    public static class SpellManager
    {
        ...
        internal static void CastAoeE(int minHit = 3)
        {
            ...
            var points = (from enemy in enemiesInRange let pred = E.GetPrediction(enemy) where pred.HitChance >= EloBuddy.SDK.Enumerations.HitChance.High select new Tuple<Vector2, float>(pred.CastPosition.To2D(), enemy.BoundingRadius)).ToList();
