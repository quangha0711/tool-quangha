...
namespace MissFortune
{
    class MissFortune
    {
        public const string ChampName = "Dr MF";
        ...
        private static void LogicQ()
        {
            ...
            {
                var qDmg = Utils.GetKsDamage(t, W.Slot);
        ...
        private static void Drawing_OnDraw(EventArgs args)
        {
            if (Config.noti && R.IsReady())
            {
                ...
                if (t.IsValidTarget())
                {
                    ...
                    {
                        Drawing.DrawText(Drawing.Width*0.1f, Drawing.Height*0.5f, Color.Blue,
                            "8 x R Wave Kill: " + t.ChampionName + " Have: " + t.Health + "HP");
                        drawLine(t.Position, Player.Position, 10, Color.Blue);
                    }
                    else if (rDamage*5 > t.Health)
                    {
                        Drawing.DrawText(Drawing.Width*0.1f, Drawing.Height*0.5f, Color.Yellow,
                            "5 x R Wave Kill: " + t.ChampionName + " Have: " + t.Health + "HP");
                        drawLine(t.Position, Player.Position, 10, Color.Yellow);
                    }
                    else if (rDamage*3 > t.Health)
                    {
                        Drawing.DrawText(Drawing.Width*0.1f, Drawing.Height*0.5f, Color.Pink,
                            "3 x R Wave Kill: " + t.ChampionName + " Have: " + t.Health + "HP");
                        drawLine(t.Position, Player.Position, 10, Color.Pink);
                    }
                    else if (rDamage > t.Health)
                    {
                        Drawing.DrawText(Drawing.Width*0.1f, Drawing.Height*0.5f, Color.Red,
                            "1 x R Wave Kill: " + t.ChampionName + " Have: " + t.Health + "HP");
